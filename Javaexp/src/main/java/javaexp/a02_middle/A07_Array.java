...
public class A07_Array {
	...
	public static void main(String[] args) {
		...
		1. 같은 타입의 데이터를 연속된 공간에 저장하는 자료구조
			...
			numbers[3]
			numbers[4]
		2. 각 데이터 저장 위치는 인덱스(0부터시작) 부여해 접근
		# 배열의 장점
		...
		String strArry[] = null;
		//		heap영역에 객체가 만들어지지 않는 상황이라서 배열의 index를 사용하면
		// 		에러가 발생
