...
<div class="container">
	<%-- action의 속성은 현재 controller단에 의해 호출한 view이고 그 이름으로
		다시 호출할 경우에는 생략 가능하다 action="/upload.do" --%>
	...
	<%--
	<form id="frm01" class="form-inline" action="${path}/uploadVo.do" enctype="multipart/form-data" method="post">
  	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	    <input type="text" name="title" class="form-control mr-sm-2" placeholder="제목" />
	    <input type="file" name="report" class="form-control mr-sm-2" placeholder="첨부파일" />
	    <button class="btn btn-info" type="submit">업로드</button>
